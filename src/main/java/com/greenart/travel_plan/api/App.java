...
//         //  https://apis.data.go.kr/B551011/KorService/areaBasedList?MobileOS=ETC&MobileApp=test&serviceKey=s6zQW6MqTihXOeY3Tcw4nD4%2FovPoQj4KVPauz4I5jqBn0M6XqUXUHSCFdD7kj22litzI3JDyVgIgDqBBLOQ4zg%3D%3D&_type=json
//         /*URL*/
...
//                 "&" + URLEncoder.encode("areaCode", StandardCharsets.UTF_8) + "=" + URLEncoder.encode("31", StandardCharsets.UTF_8) +
//                 "&" + URLEncoder.encode("sigunguCode", StandardCharsets.UTF_8) + "=" + URLEncoder.encode("1", StandardCharsets.UTF_8);
...
//         // final TravelPlaceRepository travelPlaceRepository;
//         // final TravelPlaceVO travelPlaceVO;
